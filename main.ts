...
scene.onHitWall(SpriteKind.Projectile, function (sprite, location) {
    ...
    tiles.setTileAt(location, assets.tile`splash_tile_0`)
    ...
    timer.after(100, function () {
        tiles.setTileAt(location, assets.tile`splash_tile_1`)
    ...
    timer.after(200, function () {
        tiles.setTileAt(location, assets.tile`splash_tile_2`)
